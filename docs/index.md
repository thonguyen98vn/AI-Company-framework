...
2. **State Machine:** Projects progress through strict stages (`UNINITIALIZED`, `PLANNING`, `EXECUTING`, `AUDITING`) defined in `STATE_GRAPH.md`.
...
4. **Agent Skills:** Reusable `.md` files that act as standard operating procedures for the AI.
